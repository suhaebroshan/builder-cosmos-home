          ...
          >
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-3">
                <button className="bg-purple-500/20 border border-purple-500/30 rounded-xl p-3 text-center">
                  <Wifi className="w-6 h-6 text-purple-400 mx-auto mb-1" />
                  <div className="text-white text-xs">WiFi</div>
                </button>
                <button className="bg-blue-500/20 border border-blue-500/30 rounded-xl p-3 text-center">
                  <Signal className="w-6 h-6 text-blue-400 mx-auto mb-1" />
                  <div className="text-white text-xs">Mobile</div>
                </button>
                <button className="bg-green-500/20 border border-green-500/30 rounded-xl p-3 text-center">
                  <Battery className="w-6 h-6 text-green-400 mx-auto mb-1" />
                  <div className="text-white text-xs">Battery</div>
                </button>
                
                <div className="col-span-3 mt-2">
                  <div className="text-white text-sm mb-2">Navigation Style</div>
                  <div className="flex gap-2">
                    <button
                      onClick={() => onNavigationStyleChange('gestures')}
                      className={cn(
                    ...
                    <button
                      onClick={() => onNavigationStyleChange('buttons')}
                      className={cn(
                        "flex-1 py-2 px-3 rounded-lg text-xs transition-colors",
