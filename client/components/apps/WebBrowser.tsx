      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl font-bold bg-gradient-to-r from-white/90 to-white/70 bg-clip-text text-transparent mb-2">
              Nyx Web
            </h1>
          ...
          <div className="relative max-w-2xl mx-auto">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 apple-control-panel text-white placeholder-white/60 focus:outline-none focus:ring-2 focus:ring-white/20 transition-all text-lg"
              onKeyDown={(e) => {
                if (e.key === 'Enter') {
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {bookmarks.filter(b => b.isStarred).slice(0, 8).map((bookmark) => (
            <motion.button
              ...
              className="p-4 apple-button text-center group"
